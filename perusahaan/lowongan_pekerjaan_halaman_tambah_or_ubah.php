...
if (!isAccessAllowed('perusahaan')) :
  ...
  mysqli_stmt_prepare($stmt_perusahaan, "SELECT nama_perusahaan, alamat_perusahaan FROM tbl_perusahaan WHERE id=?");
  mysqli_stmt_bind_param($stmt_perusahaan, 'i', $_SESSION['id_perusahaan']);
  mysqli_stmt_execute($stmt_perusahaan);

  $result = mysqli_stmt_get_result($stmt_perusahaan);
                ...
                <div class="col-lg-4">
                  <div class="card">
                    ...
                    <div class="card-body text-center p-5">
                      ...
                      <p class="mb-4"><?= $perusahaan['alamat_perusahaan'] ?></p>
