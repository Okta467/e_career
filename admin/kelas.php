                  ...
                  <tbody>
                    ...
                    ?>
                      ...
                      <tr>
                        <td><?= $no++ ?></td>
                        <td>
                          <?= htmlspecialchars($kelas['nama_wali_kelas']); ?>
                          <?= !empty($kelas['nip'])
                            ? "<br><small class='text-muted'>({$kelas['nip']})</small>"
        ...
        <div class="modal-content">
          ...
          <form>
            <div class="modal-body">
              ...
              <div class="mb-3">
                <label class="small mb-1" for="xid_wali_kelas">Pendidikan</label>
                <select name="xid_wali_kelas" class="form-control select2" id="xid_wali_kelas" required>
                  <option value="">-- Pilih --</option>
                  <?php $query_guru = mysqli_query($connection, "SELECT * FROM tbl_guru ORDER by nama_guru ASC") ?>
    ...
    <script>
      $(document).ready(function() {
        ...
        $('.toggle_modal_ubah').on('click', function() {
          ...
          $('#ModalInputKelas #xid_wali_kelas').val(id_wali_kelas).trigger('change');
