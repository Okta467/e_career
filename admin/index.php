              ...
              <div class="card-body p-5">
                <div class="row align-items-center justify-content-between">
                  <div class="col">
                    ...
                    <p class="text-gray-700"><?= SITE_NAME_SHORT ?> merupakan sistem informasi untuk membantu alumni mencari lowongan pekerjaan atau bursa kerja pada perusahaan yang bekerja sama dengan sekolah di SMK Tunas Harapan, Palembang.</p>
