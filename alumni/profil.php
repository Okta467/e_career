                ...
                <table id="datatablesSimple">
                  <thead>
                    <tr>
                      ...
                      <th>No. Telepon</th>
                      <th>Email</th>
                      <th>Ubah Profil <br>/ Detail Alumni</th> </tr>
                  </thead>
                  <tbody>
        ...
        <div class="modal-content">
          ...
          <form>
            <div class="modal-body">
              ...
              <div class="mb-3">
                <label class="small mb-1" for="xnama_alumni">Nama Alumni</label>
                <input class="form-control" id="xnama_alumni" type="text" name="xnama_alumni" placeholder="Enter nama Alumni" disabled>
              </div>
    ...
    <script>
      $(document).ready(function() {
        ...
        $('.toggle_modal_ubah').on('click', function() {
          ...
          $('#ModalInputAlumni form').attr({action: 'profil_ubah.php', method: 'post'});
