                ...
                <table id="datatablesSimple">
                  ...
                  <tbody>
                    ...
                    $query_keahlian_alumni = mysqli_query($connection, 
                      ...
                      WHERE d.id_alumni = {$_SESSION['id_alumni']}");
            ...
            <div class="modal-body">
              ...
              <div class="mb-3">
                ...
                <select name="xid_alumni" class="form-control select2" id="xid_alumni" required>
                  <?php $query_alumni = mysqli_query($connection, "SELECT * FROM tbl_alumni WHERE id = {$_SESSION['id_alumni']}") ?>
                  <?php while ($keahlian_alumni = mysqli_fetch_assoc($query_alumni)): ?>
          
                    <option value="<?= $keahlian_alumni['id'] ?>" selected><?= $keahlian_alumni['nama_alumni'] ?></option>
