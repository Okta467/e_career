<?php
    ...
    mysqli_stmt_prepare($stmt, "INSERT INTO tbl_keahlian_alumni (id_alumni, nama_keahlian, file_keahlian) VALUES (?, ?, ?)");
    mysqli_stmt_bind_param($stmt, 'iss', $id_alumni, $nama_keahlian, $nama_berkas);
