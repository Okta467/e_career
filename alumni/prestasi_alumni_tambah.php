<?php
    ...
    mysqli_stmt_prepare($stmt, "INSERT INTO tbl_prestasi_alumni (id_alumni, nama_prestasi, file_prestasi) VALUES (?, ?, ?)");
    mysqli_stmt_bind_param($stmt, 'iss', $id_alumni, $nama_prestasi, $nama_berkas);
