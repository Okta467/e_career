<?php
    ...
    $password_confirm = $_POST['xpassword_confirm'];
    ...
    if (!$id_kelas || !$nisn || !$nama_alumni || !$username || !$password || !$password_confirm || !$password_hashed || !$hak_akses || !$jk || !$email) {
        $_SESSION['msg'] = 'Terdapat input wajib yang tidak terisi!';
        echo "<meta http-equiv='refresh' content='0;alumni_registration.php'>";
        return;
    }
    ...
    try {
        ...
        mysqli_stmt_bind_param($stmt_pengguna, 'sss', $username, $password_hashed, $hak_akses);
    ...
    echo !$success
        ? "<meta http-equiv='refresh' content='0;alumni_registration.php'>"
